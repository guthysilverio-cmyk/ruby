...
t2.value10 = "https://license-manager-system--rianlevi555.replit.app/api/license/verify"
t2.value11 = nil
...
function t2.value17(p5)
    ...
    local v162 = _tostring(p5):gsub("%s+", "")

    if v162 == "" then
        return false, "INVALID"
    end

    local v163 = t2.value16()
    ...
    local str = tostring(result.Body or (result.body or ""))
    local v171 = str:gsub("%s+", "")
    local ok2, result2 = pcall(function()
        return t2.value8:JSONDecode(str)
    end)
    ...
    if ok2 then
        v171 = tostring(result2.status or "INVALID")
    end
