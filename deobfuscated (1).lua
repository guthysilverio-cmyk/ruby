...
t2.value10 = "https://keyauth.win/api/1.1/"
t2.value11 = nil
...
function t2.value17(p5)
    ...
    local ok, accepted, status = pcall(function()
        ...
        local initBody = game:HttpGet(initUrl)
        local initData = t2.value8:JSONDecode(initBody)

        if initBody == "KeyAuth_Invalid" or type(initData) ~= "table" or initData.success ~= true then
            return false, tostring(initData and initData.message or "API_ERROR")
        end
        ...
        local licenseData = t2.value8:JSONDecode(game:HttpGet(licenseUrl))
...
TextLabel.Text = "RUBY KEY SYSTEM"
TextLabel.TextColor3 = Color3.fromRGB(180, 90, 255)
TextLabel.TextSize = 18
TextLabel.Font = Enum.Font.GothamBold
TextLabel.Parent = Frame
t2.value21 = Instance.new("TextBox")
t2.value21.Size = UDim2.new(1, -40, 0, 42)
t2.value21.Position = UDim2.new(0, 20, 0, 55)
t2.value21.PlaceholderText = "Digite sua Key"
t2.value21.Text = ""
...
t2.value22.Size = UDim2.new(1, -40, 0, 42)
t2.value22.Position = UDim2.new(0, 20, 0, 110)
...
TextLabel2.Size = UDim2.new(1, -40, 0, 20)
TextLabel2.Position = UDim2.new(0, 20, 0, 155)
TextLabel2.BackgroundTransparency = 1
TextLabel2.Text = "HWID salvo para não trocar todo dia"
...
function t2.value49()
    ...
    if t2.value55 then
        ...
        t2.value55.Text = not t2.value54 and "🔓" or "🔒"
        t2.value55.BackgroundColor3 = t2.value54 and Color3.fromRGB(80, 20, 20) or Color3.fromRGB(20, 40, 20)
    end
end
...
t2.value55.Position = UDim2.new(1, -48, 0.94, 0)
t2.value55.BackgroundColor3 = Color3.fromRGB(20, 40, 20)
...
local function v109(p112)
    ...
    if p112 == "PC" and not t2.value25 then
        ...
        t2.value124.Text = "RUBY  |  PARKER GOAT  |  PC PRO"
        ...
        t2.value124.Text = "RUBY  |  PARKER GOAT  |  MOBILE"
...
print("✅ RUBY UI - Criador: PARKER GOAT - Carregado com sucesso.")
